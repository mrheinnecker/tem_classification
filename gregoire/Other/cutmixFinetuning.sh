...
# Run your script
srun --ntasks=4 bash -c 'export CUDA_VISIBLE_DEVICES=$SLURM_LOCALID;  python /g/schwab/GregoireMichelDeletie/Codes/cutmixFinetuning.py'
