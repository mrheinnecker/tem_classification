...
bash "${local_repo_clone}/scripts_marco/main.sh"


## OPTION 2:
local_repo_clone="/g/schwab/marco/repos/tem_classification"
sbatch -J "wfTEM" -t 2:00:00 --mem 2000 -e "/scratch/tem_screen/log.txt" -o "/scratch/tem_screen/log.out" --wrap="bash "${local_repo_clone}/scripts_marco/main.sh""
