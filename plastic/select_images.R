...
#   dryrun = "FALSE",
#   dryrun_n = 2L,
#   existing_s3 = "C:/projects/plastic_screen/existing_s3_entries.txt",
#   default_x_scale = "",
#   default_y_scale = "",
#   default_z_scale = "",
#   scale_unit = "nm"
...
outdir <- value_or_default(opt$outdir, "plastic_processed")
...
all_images <- images %>%
  ...
  mutate(
    ...
    x_scale=PLASTIC_x_scale,
    y_scale=PLASTIC_y_scale,
    z_scale=PLASTIC_z_scale,
    scale_unit=PLASTIC_scale_unit,
