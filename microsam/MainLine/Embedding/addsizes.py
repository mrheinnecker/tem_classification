...
def add_sizes(n,destination):
    ...
    masks=[f"c{n}o{i}.png" for i in masks]
...
def add_avg(n,destination):
    ...
    image=dataset['s3']
    mask =np.asarray(Image.open("/g/schwab/marco/projects/tem_classification/slurm_outputs/cell_nb_"+n+"/mask_"+MODEL_TYPE+"_merged.png")).copy()
    ...
    for label in labels:
        ...
        avg_intensities[f"c{n}o{i}.png"] = avg_intensity
